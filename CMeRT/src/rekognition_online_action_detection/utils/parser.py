...
def assert_and_infer_cfg(cfg, args):
    ...
    # Infer memory
    cfg.MODEL.LSTR.LONG_MEMORY_LENGTH = int(cfg.MODEL.LSTR.LONG_MEMORY_SECONDS * cfg.DATA.FPS) # 512*3.125=1600
    cfg.MODEL.LSTR.WORK_MEMORY_LENGTH = int(cfg.MODEL.LSTR.WORK_MEMORY_SECONDS * cfg.DATA.FPS) # 8*3.125=25
    cfg.MODEL.LSTR.TOTAL_MEMORY_LENGTH = cfg.MODEL.LSTR.LONG_MEMORY_LENGTH + cfg.MODEL.LSTR.WORK_MEMORY_LENGTH
    cfg.MODEL.LSTR.ANTICIPATION_LENGTH = cfg.MODEL.LSTR.ANTICIPATION_SECONDS * int(cfg.DATA.FPS) # 2*3=6
    cfg.MODEL.LSTR.FUTURE_LENGTH = cfg.MODEL.LSTR.FUTURE_SECONDS * int(cfg.DATA.FPS) # 16*3=48
